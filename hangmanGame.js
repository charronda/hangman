...
var hangmanGame = {
  ...
  // Object of all words that can be chosen, along with info such as their picture and a bio clip.
  wordsToPick: {
    leia: {
      picture: "Leia.jpg",
      bio:"Princess Leia Organa of Alderaan",
      preview: "https://en.wikipedia.org/wiki/Princess_Leia"
    },
    amidala: {
      picture: "amidala.jpg",
      bio: "Padmé Amidala of Naberrie",
      preview: "https://en.wikipedia.org/wiki/Padm%C3%A9_Amidala"
    },
    vader: {
      picture: "vader.jpg",
      bio: "Darth Vader after the death of Anakin Skywalker",
      preview: "https://en.wikipedia.org/wiki/Darth_Vader"
    },
    jakku: {
      picture: "jakku.jpg",
      bio: "Rey's home Planet",
      preview: "https://en.wikipedia.org/wiki/Jakku"
    },
    tatooine: {
      picture: "tatooine.jpg",
      bio: "Skywalker Home Planet",
      preview: "https://en.wikipedia.org/wiki/Tatooine"
    },
    starfighter: {
      picture: "starfighter.jpg",
      bio: "Star Wars fighter ships",
      preview: "https://en.wikipedia.org/wiki/List_of_Star_Wars_starfighters"
    },
    anakin: {
      picture: "anakin.jpg",
      bio: "Anakin Skywalker, the man before Vader!",
      preview: "https://en.wikipedia.org/wiki/Darth_Vader"
    },
    hansolo: {
      picture: "hansolo.jpg",
      bio: "Han Solo",
      preview: "https://en.wikipedia.org/wiki/Han_Solo"
    },
    skywalker: {
      picture: "skywalker.jpg",
      bio: "The Skywalker Family Tree",
      preview: "https://en.wikipedia.org/wiki/Skywalker_family"
    },
    chewbacca: {
      picture: "chewbacca.jpg",
      bio: "Chewbacca, last surviving Wookiee",
      preview: "https://en.wikipedia.org/wiki/Chewbacca"
    },
    kenobi: {
      picture: "kenobi.jpg",
      bio: "Obi-Wan Kenobi",
      preview: "https://en.wikipedia.org/wiki/Obi-Wan_Kenobi"
    }
  },
  ...
  updateWins: function() {
    ...
    if (win) {
      ...
      // Update the bio title and band on the page.
      document.querySelector("#music").innerHTML = this.wordsToPick[this.wordInPlay].bio +
      " By " + this.wordInPlay;
      ...
      document.querySelector("#bandDiv").innerHTML =
        ...
        this.wordsToPick[this.wordInPlay].bio + "'>";
